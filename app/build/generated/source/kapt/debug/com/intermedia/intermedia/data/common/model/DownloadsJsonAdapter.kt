...
public class DownloadsJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<Downloads>() {
  ...
  public override fun toString(): String = buildString(31) {
      append("GeneratedJsonAdapter(").append("Downloads").append(')') }

  public override fun fromJson(reader: JsonReader): Downloads {
    var total: Int? = null
  ...
  public override fun toJson(writer: JsonWriter, value_: Downloads?): Unit {
    if (value_ == null) {

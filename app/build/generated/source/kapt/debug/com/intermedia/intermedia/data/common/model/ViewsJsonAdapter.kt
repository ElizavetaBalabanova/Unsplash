...
public class ViewsJsonAdapter(
  ...
  public override fun toString(): String = buildString(27) {
      append("GeneratedJsonAdapter(").append("Views").append(')') }

  public override fun fromJson(reader: JsonReader): Views {
    var total: Int? = null
  ...
  public override fun toJson(writer: JsonWriter, value_: Views?): Unit {
    if (value_ == null) {

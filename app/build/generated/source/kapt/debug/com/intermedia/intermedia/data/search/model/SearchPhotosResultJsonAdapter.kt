...
public class SearchPhotosResultJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<SearchPhotosResult>() {
  ...
  private val listOfPhotoAdapter: JsonAdapter<List<Photo>> =
  ...
  public override fun toString(): String = buildString(40) {
      append("GeneratedJsonAdapter(").append("SearchPhotosResult").append(')') }

  public override fun fromJson(reader: JsonReader): SearchPhotosResult {
    var total: Int? = null
    ...
    while (reader.hasNext()) {
      when (reader.selectName(options)) {
        ...
        1 -> total_pages = intAdapter.fromJson(reader) ?: throw Util.unexpectedNull("total_pages",
            "total_pages", reader)
        2 -> results = listOfPhotoAdapter.fromJson(reader) ?: throw Util.unexpectedNull("results",
            "results", reader)
        -1 -> {
  ...
  public override fun toJson(writer: JsonWriter, value_: SearchPhotosResult?): Unit {
    if (value_ == null) {
    ...
    writer.name("results")
    listOfPhotoAdapter.toJson(writer, value_.results)
    writer.endObject()
  }
}

...
public class UserStatisticsJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<UserStatistics>() {
  private val options: JsonReader.Options = JsonReader.Options.of("username", "downloads", "views",
      "likes")
  ...
  public override fun toString(): String = buildString(36) {
      append("GeneratedJsonAdapter(").append("UserStatistics").append(')') }

  public override fun fromJson(reader: JsonReader): UserStatistics {
  ...
  public override fun toJson(writer: JsonWriter, value_: UserStatistics?): Unit {
    if (value_ == null) {

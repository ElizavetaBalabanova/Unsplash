...
public final class ItemCollectionMinimalBinding implements ViewBinding {
  @NonNull
  ...
  private ItemCollectionMinimalBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView collectionCountTextView, @NonNull ImageView collectionImageView,
      @NonNull TextView collectionNameTextView, @NonNull ImageView collectionPrivateIcon) {
  ...
  @NonNull
  public static ItemCollectionMinimalBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemCollectionMinimalBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_collection_minimal, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemCollectionMinimalBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCollectionMinimalBinding((ConstraintLayout) rootView, collectionCountTextView,
          collectionImageView, collectionNameTextView, collectionPrivateIcon);
    }

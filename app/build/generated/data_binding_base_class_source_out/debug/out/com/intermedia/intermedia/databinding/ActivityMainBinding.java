...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull CoordinatorLayout rootView,
      @NonNull BottomAppBar bottomAppBar, @NonNull AutoSizeTabLayout tabLayout,
      @NonNull AppBarLayout topAppBar, @NonNull ViewPager viewPager) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((CoordinatorLayout) rootView, bottomAppBar, tabLayout,
          topAppBar, viewPager);
    }
